...
% Function modified by Nuno Fachada in 2017 for usage with micompm
% according to the GNU General Public License version 3. Modifications
% include: 
% - Matlab compatibility
% - Suppress output
% - Return 1st Wilks' p-value 

function W_pval_1 = manova_micomp (x, g)
